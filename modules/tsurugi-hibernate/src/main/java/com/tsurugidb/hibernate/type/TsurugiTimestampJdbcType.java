...
/**
 * Tsurugi Timestamp JdbcType.
 */
@SuppressWarnings("serial")
public class TsurugiTimestampJdbcType extends TimestampJdbcType {

    /** instance */
    public static final TsurugiTimestampJdbcType INSTANCE = new TsurugiTimestampJdbcType();

    /**
     * Creates a new instance.
     */
    public TsurugiTimestampJdbcType() {
    }
